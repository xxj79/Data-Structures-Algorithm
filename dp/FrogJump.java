...
public class FrogJump {
	//Use hashmap to store corresponding steps at certain position we can take
	...
	/*DFS solution faster (try the largest jump first which may reduce the recursion times)
	 * Use a set to store all valid positions, and always try large step first!!
